    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          ...
          ?>
          <form class="row" action="<?= htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" enctype="multipart/form-data">
            <div class="form-group col-6">
              ...
              <div class="form-group col-6">
                ...
                <input name="discount" type="number" min="0" max="100" class="form-control" value="<?= isset($values['discount']) ? $values['discount'] : '' ?>" />
