...
$getPageUrl = function ($i) use ($itemPerPage, $category_id, $keyword, $colors, $sizes, $prices) {
  $url =  $_SERVER['PHP_SELF'] . "?" . http_build_query([
    "page" => $i,
      ...
      <div class="col-lg-3 col-md-4">
        ...
        <div class="bg-light p-4 mb-30">
          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-all" value="0" name="prices[]" <?= $getHasPrice("0") ? 'checked' : '' ?>>
            <label class="custom-control-label" for="price-all">All Price</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="price-1" name="prices[]" value="0-100" <?= $getHasPrice("0-100") ? 'checked' : '' ?>>
            <label class="custom-control-label" for="price-1" name="prices[]">$0 - $100</label>
          </div>
          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="bg-light p-4 mb-30">
          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="color-all" value="0" name="colors[]" <?= $getHasColor("0") ? 'checked' : '' ?>>
            <label class="custom-control-label" for="colors-all">All Color</label>
          </div>
          ...
          ?>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
              <input type="checkbox" class="custom-control-input" id="color-<?= $color["id"] ?>" name="colors[]" value="<?= $color['id'] ?>" <?= $getHasColor($color["id"]) ? 'checked' : '' ?>>
        ...
        <div class="bg-light p-4 mb-30">
          <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
            <input type="checkbox" class="custom-control-input" id="size-all" value="0" name="sizes[]" <?= $getHasColor("0") ? 'checked' : '' ?>>
          ...
          ?>
            <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
              <input type="checkbox" class="custom-control-input" id="size-<?= $size["id"] ?>" name="sizes[]" value="<?= $size['id'] ?>" <?= $getHasSize($size["id"]) ? 'checked' : '' ?>>
      ...
      <div class="col-lg-9 col-md-8">
        <div class="row pb-3">
          ...
          foreach ($products as $product) {
            echo display_products($product, 'col-lg-4 col-md-6 col-sm-6 pb-1');
          }
          ?>
          ...
          <div class="col-12">
            <nav>
              <ul class="pagination justify-content-center">
                ...
                ?>
                  <li class="page-item <?= $i == $page ? "active" : "" ?>"><a class="page-link" href="<?= $getPageUrl($i) ?>"><?= $i + 1 ?></a></li>
                <?php
                }
                ?>
