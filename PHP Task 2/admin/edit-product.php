...
if ($_SERVER["REQUEST_METHOD"] === "POST" && $_POST) {
  ...
  if ($file) {
    ...
    // If the user didn't edit image (select another image), keep the original one.
    // don't show errors.
...
<div class="container-fluid">
  <div class="row bg-secondary py-1 px-xl-5 d-flex d-flex justify-content-center mb-2">
    <div class="col-lg-8 d-none d-lg-block">
      ...
      <form action="<?= $_SERVER["PHP_SELF"] . "?id=" . $oldValues["id"] ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <img src="<?= "../" . $oldValues["image_url"] ?>" alt="">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="number" class="form-control" id="discount" name="discount" min="0" max="100" step="0.1" value="<?= isset($oldValues["discount"]) ? $oldValues["discount"] * 100 : ""  ?>">
